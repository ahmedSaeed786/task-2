...
Route::post('user_delete', [userController::class, 'destroy'])->name('user_delete')->middleware('auth');
...
Route::post('invoice', [CustomerController::class, 'invoice'])->name('invoice')->middleware('auth');
...
Route::post('/destroy', [CustomerController::class, 'destroy'])->name('destroy')->middleware('auth');
Route::get('list', [OrderController::class, 'index'])->name('list')->middleware('auth');
